 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TNotificationInterfaceImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TNotificationInterfaceImpl#getPortType <em>Port Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TNotificationInterfaceImpl extends TExtensibleElementsImpl implements TNotificationInterface {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TNOTIFICATION_INTERFACE;
	}
	...
	public void setOperation(String newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TNOTIFICATION_INTERFACE__OPERATION, oldOperation, operation));
	}
	...
	public void setPortType(QName newPortType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TNOTIFICATION_INTERFACE__PORT_TYPE, oldPortType, portType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case htdPackage.TNOTIFICATION_INTERFACE__OPERATION:
				return getOperation();
			case htdPackage.TNOTIFICATION_INTERFACE__PORT_TYPE:
				return getPortType();
		}
