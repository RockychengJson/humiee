 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getImport <em>Import</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getLogicalPeopleGroups <em>Logical People Groups</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getTasks <em>Tasks</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getNotifications <em>Notifications</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getExpressionLanguage <em>Expression Language</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getQueryLanguage <em>Query Language</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.THumanInteractionsImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class THumanInteractionsImpl extends TExtensibleElementsImpl implements THumanInteractions {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.THUMAN_INTERACTIONS;
	}
	...
	public NotificationChain basicSetExtensions(TExtensions newExtensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__EXTENSIONS, oldExtensions, newExtensions);
	...
	public void setExtensions(TExtensions newExtensions) {
		if (newExtensions != extensions) {
			...
			if (extensions != null)
				msgs = ((InternalEObject)extensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__EXTENSIONS, null, msgs);
			if (newExtensions != null)
				msgs = ((InternalEObject)newExtensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__EXTENSIONS, null, msgs);
			msgs = basicSetExtensions(newExtensions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__EXTENSIONS, newExtensions, newExtensions));
	}
	...
	public EList<TImport> getImport() {
		if (import_ == null) {
			import_ = new EObjectContainmentEList<TImport>(TImport.class, this, htdPackage.THUMAN_INTERACTIONS__IMPORT);
		}
		return import_;
	}
	...
	public NotificationChain basicSetLogicalPeopleGroups(TLogicalPeopleGroups newLogicalPeopleGroups, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__LOGICAL_PEOPLE_GROUPS, oldLogicalPeopleGroups, newLogicalPeopleGroups);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLogicalPeopleGroups(TLogicalPeopleGroups newLogicalPeopleGroups) {
		if (newLogicalPeopleGroups != logicalPeopleGroups) {
			...
			if (logicalPeopleGroups != null)
				msgs = ((InternalEObject)logicalPeopleGroups).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__LOGICAL_PEOPLE_GROUPS, null, msgs);
			if (newLogicalPeopleGroups != null)
				msgs = ((InternalEObject)newLogicalPeopleGroups).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__LOGICAL_PEOPLE_GROUPS, null, msgs);
			msgs = basicSetLogicalPeopleGroups(newLogicalPeopleGroups, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__LOGICAL_PEOPLE_GROUPS, newLogicalPeopleGroups, newLogicalPeopleGroups));
	}
	...
	public NotificationChain basicSetTasks(TTasks newTasks, NotificationChain msgs) {
		...
		tasks = newTasks;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__TASKS, oldTasks, newTasks);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTasks(TTasks newTasks) {
		if (newTasks != tasks) {
			NotificationChain msgs = null;
			if (tasks != null)
				msgs = ((InternalEObject)tasks).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__TASKS, null, msgs);
			if (newTasks != null)
				msgs = ((InternalEObject)newTasks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__TASKS, null, msgs);
			msgs = basicSetTasks(newTasks, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__TASKS, newTasks, newTasks));
	}
	...
	public NotificationChain basicSetNotifications(TNotifications newNotifications, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__NOTIFICATIONS, oldNotifications, newNotifications);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNotifications(TNotifications newNotifications) {
		if (newNotifications != notifications) {
			...
			if (notifications != null)
				msgs = ((InternalEObject)notifications).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__NOTIFICATIONS, null, msgs);
			if (newNotifications != null)
				msgs = ((InternalEObject)newNotifications).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.THUMAN_INTERACTIONS__NOTIFICATIONS, null, msgs);
			msgs = basicSetNotifications(newNotifications, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__NOTIFICATIONS, newNotifications, newNotifications));
	}
	...
	public void setExpressionLanguage(String newExpressionLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__EXPRESSION_LANGUAGE, oldExpressionLanguage, expressionLanguage));
	}
	...
	public void setQueryLanguage(String newQueryLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__QUERY_LANGUAGE, oldQueryLanguage, queryLanguage));
	}
	...
	public void setTargetNamespace(String newTargetNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.THUMAN_INTERACTIONS__TARGET_NAMESPACE, oldTargetNamespace, targetNamespace));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case htdPackage.THUMAN_INTERACTIONS__EXTENSIONS:
				return basicSetExtensions(null, msgs);
			case htdPackage.THUMAN_INTERACTIONS__IMPORT:
				return ((InternalEList<?>)getImport()).basicRemove(otherEnd, msgs);
			case htdPackage.THUMAN_INTERACTIONS__LOGICAL_PEOPLE_GROUPS:
				return basicSetLogicalPeopleGroups(null, msgs);
			case htdPackage.THUMAN_INTERACTIONS__TASKS:
				return basicSetTasks(null, msgs);
			case htdPackage.THUMAN_INTERACTIONS__NOTIFICATIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case htdPackage.THUMAN_INTERACTIONS__EXPRESSION_LANGUAGE:
				return getExpressionLanguage();
			case htdPackage.THUMAN_INTERACTIONS__QUERY_LANGUAGE:
				return getQueryLanguage();
			case htdPackage.THUMAN_INTERACTIONS__TARGET_NAMESPACE:
