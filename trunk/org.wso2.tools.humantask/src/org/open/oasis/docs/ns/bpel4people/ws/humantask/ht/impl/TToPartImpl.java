 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TToPartImpl#getExpressionLanguage <em>Expression Language</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TToPartImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TToPartImpl extends TExtensibleMixedContentElementsImpl implements TToPart {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TTO_PART;
	}
	...
	public void setExpressionLanguage(String newExpressionLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTO_PART__EXPRESSION_LANGUAGE, oldExpressionLanguage, expressionLanguage));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTO_PART__NAME, oldName, name));
	}
