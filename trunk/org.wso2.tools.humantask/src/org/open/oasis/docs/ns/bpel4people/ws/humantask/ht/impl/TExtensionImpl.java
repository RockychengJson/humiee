 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TExtensionImpl#getMustUnderstand <em>Must Understand</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TExtensionImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TExtensionImpl extends TExtensibleElementsImpl implements TExtension {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TEXTENSION;
	}
	...
	public void setMustUnderstand(TBoolean newMustUnderstand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TEXTENSION__MUST_UNDERSTAND, oldMustUnderstand, mustUnderstand, !oldMustUnderstandESet));
	}
	...
	public void unsetMustUnderstand() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, htdPackage.TEXTENSION__MUST_UNDERSTAND, oldMustUnderstand, MUST_UNDERSTAND_EDEFAULT, oldMustUnderstandESet));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TEXTENSION__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case htdPackage.TEXTENSION__MUST_UNDERSTAND:
				return getMustUnderstand();
			case htdPackage.TEXTENSION__NAMESPACE:
				return getNamespace();
		}
