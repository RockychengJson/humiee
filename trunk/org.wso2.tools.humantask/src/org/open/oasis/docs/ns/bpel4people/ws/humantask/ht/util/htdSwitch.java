...
public class htdSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case htdPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case htdPackage.TARGUMENT: {
			...
			case htdPackage.TDEADLINE_EXPR: {
			...
			case htdPackage.TEXTENSIBLE_MIXED_CONTENT_ELEMENTS: {
			...
			case htdPackage.TGENERIC_HUMAN_ROLE: {
			...
			case htdPackage.TLOGICAL_PEOPLE_GROUP: {
			...
			case htdPackage.TLOGICAL_PEOPLE_GROUPS: {
			...
			case htdPackage.TNOTIFICATION_INTERFACE: {
			...
			case htdPackage.TNOTIFICATIONS: {
			...
			case htdPackage.TORGANIZATIONAL_ENTITY: {
			...
			case htdPackage.TPEOPLE_ASSIGNMENTS: {
			...
			case htdPackage.TPRESENTATION_ELEMENTS: {
			...
			case htdPackage.TPRESENTATION_PARAMETER: {
			...
			case htdPackage.TPRESENTATION_PARAMETERS: {
			...
			case htdPackage.TTASK_INTERFACE: {
