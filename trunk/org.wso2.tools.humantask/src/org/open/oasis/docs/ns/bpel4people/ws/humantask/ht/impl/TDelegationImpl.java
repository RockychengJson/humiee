 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TDelegationImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TDelegationImpl#getPotentialDelegatees <em>Potential Delegatees</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TDelegationImpl extends TExtensibleElementsImpl implements TDelegation {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TDELEGATION;
	}
	...
	public NotificationChain basicSetFrom(TFrom newFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.TDELEGATION__FROM, oldFrom, newFrom);
	...
	public void setFrom(TFrom newFrom) {
		if (newFrom != from) {
			...
			if (from != null)
				msgs = ((InternalEObject)from).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.TDELEGATION__FROM, null, msgs);
			if (newFrom != null)
				msgs = ((InternalEObject)newFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.TDELEGATION__FROM, null, msgs);
			msgs = basicSetFrom(newFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TDELEGATION__FROM, newFrom, newFrom));
	}
	...
	public void setPotentialDelegatees(TPotentialDelegatees newPotentialDelegatees) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TDELEGATION__POTENTIAL_DELEGATEES, oldPotentialDelegatees, potentialDelegatees, !oldPotentialDelegateesESet));
	}
	...
	public void unsetPotentialDelegatees() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, htdPackage.TDELEGATION__POTENTIAL_DELEGATEES, oldPotentialDelegatees, POTENTIAL_DELEGATEES_EDEFAULT, oldPotentialDelegateesESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case htdPackage.TDELEGATION__FROM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case htdPackage.TDELEGATION__FROM:
				return getFrom();
			case htdPackage.TDELEGATION__POTENTIAL_DELEGATEES:
