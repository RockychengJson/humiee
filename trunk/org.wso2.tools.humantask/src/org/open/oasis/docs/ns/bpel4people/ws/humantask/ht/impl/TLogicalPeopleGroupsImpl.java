 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TLogicalPeopleGroupsImpl#getLogicalPeopleGroup <em>Logical People Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TLogicalPeopleGroupsImpl extends TExtensibleElementsImpl implements TLogicalPeopleGroups {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TLOGICAL_PEOPLE_GROUPS;
	}
	...
	public EList<TLogicalPeopleGroup> getLogicalPeopleGroup() {
		if (logicalPeopleGroup == null) {
			logicalPeopleGroup = new EObjectContainmentEList<TLogicalPeopleGroup>(TLogicalPeopleGroup.class, this, htdPackage.TLOGICAL_PEOPLE_GROUPS__LOGICAL_PEOPLE_GROUP);
		}
