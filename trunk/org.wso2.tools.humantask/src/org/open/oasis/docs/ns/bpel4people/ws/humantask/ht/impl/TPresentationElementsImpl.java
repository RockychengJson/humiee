 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TPresentationElementsImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TPresentationElementsImpl#getPresentationParameters <em>Presentation Parameters</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TPresentationElementsImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TPresentationElementsImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPresentationElementsImpl extends TExtensibleElementsImpl implements TPresentationElements {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TPRESENTATION_ELEMENTS;
	}
	...
	public EList<TText> getName() {
		if (name == null) {
			name = new EObjectContainmentEList<TText>(TText.class, this, htdPackage.TPRESENTATION_ELEMENTS__NAME);
		}
		return name;
	}
	...
	public NotificationChain basicSetPresentationParameters(TPresentationParameters newPresentationParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.TPRESENTATION_ELEMENTS__PRESENTATION_PARAMETERS, oldPresentationParameters, newPresentationParameters);
	...
	public void setPresentationParameters(TPresentationParameters newPresentationParameters) {
		if (newPresentationParameters != presentationParameters) {
			...
			if (presentationParameters != null)
				msgs = ((InternalEObject)presentationParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.TPRESENTATION_ELEMENTS__PRESENTATION_PARAMETERS, null, msgs);
			if (newPresentationParameters != null)
				msgs = ((InternalEObject)newPresentationParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.TPRESENTATION_ELEMENTS__PRESENTATION_PARAMETERS, null, msgs);
			msgs = basicSetPresentationParameters(newPresentationParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TPRESENTATION_ELEMENTS__PRESENTATION_PARAMETERS, newPresentationParameters, newPresentationParameters));
	}
	...
	public EList<TText> getSubject() {
		if (subject == null) {
			subject = new EObjectContainmentEList<TText>(TText.class, this, htdPackage.TPRESENTATION_ELEMENTS__SUBJECT);
		}
		return subject;
	}
	...
	public EList<TDescription> getDescription() {
		if (description == null) {
			description = new EObjectContainmentEList<TDescription>(TDescription.class, this, htdPackage.TPRESENTATION_ELEMENTS__DESCRIPTION);
		}
		return description;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case htdPackage.TPRESENTATION_ELEMENTS__NAME:
				return ((InternalEList<?>)getName()).basicRemove(otherEnd, msgs);
			case htdPackage.TPRESENTATION_ELEMENTS__PRESENTATION_PARAMETERS:
				return basicSetPresentationParameters(null, msgs);
			case htdPackage.TPRESENTATION_ELEMENTS__SUBJECT:
				return ((InternalEList<?>)getSubject()).basicRemove(otherEnd, msgs);
			case htdPackage.TPRESENTATION_ELEMENTS__DESCRIPTION:
