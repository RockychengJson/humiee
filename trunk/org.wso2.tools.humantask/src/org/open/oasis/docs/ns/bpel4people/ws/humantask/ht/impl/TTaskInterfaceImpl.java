 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TTaskInterfaceImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TTaskInterfaceImpl#getPortType <em>Port Type</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TTaskInterfaceImpl#getResponseOperation <em>Response Operation</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TTaskInterfaceImpl#getResponsePortType <em>Response Port Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TTaskInterfaceImpl extends TExtensibleElementsImpl implements TTaskInterface {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TTASK_INTERFACE;
	}
	...
	public void setOperation(String newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTASK_INTERFACE__OPERATION, oldOperation, operation));
	}
	...
	public void setPortType(QName newPortType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTASK_INTERFACE__PORT_TYPE, oldPortType, portType));
	}
	...
	public void setResponseOperation(String newResponseOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTASK_INTERFACE__RESPONSE_OPERATION, oldResponseOperation, responseOperation));
	}
	...
	public void setResponsePortType(QName newResponsePortType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TTASK_INTERFACE__RESPONSE_PORT_TYPE, oldResponsePortType, responsePortType));
	}
