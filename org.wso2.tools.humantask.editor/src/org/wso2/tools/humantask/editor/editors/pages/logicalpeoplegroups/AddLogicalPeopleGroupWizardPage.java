...
public class AddLogicalPeopleGroupWizardPage extends WizardPage {

	 public static final String PAGE_NAME ="Add logical People Group Page";
	 private Text nametextbox;
	 
	 public AddLogicalPeopleGroupWizardPage() {
	
		 super(PAGE_NAME ,"Add Logical People Group" , null);
