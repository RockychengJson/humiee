 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TImportImpl#getImportType <em>Import Type</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TImportImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TImportImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TImportImpl extends TExtensibleElementsImpl implements TImport {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TIMPORT;
	}
	...
	public void setImportType(String newImportType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TIMPORT__IMPORT_TYPE, oldImportType, importType));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TIMPORT__LOCATION, oldLocation, location));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TIMPORT__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case htdPackage.TIMPORT__IMPORT_TYPE:
				return getImportType();
			case htdPackage.TIMPORT__LOCATION:
				return getLocation();
			case htdPackage.TIMPORT__NAMESPACE:
				return getNamespace();
		}
