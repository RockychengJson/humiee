 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.ns.bpel4people.ws.humantask.ht.impl.TReassignmentImpl#getPotentialOwners <em>Potential Owners</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TReassignmentImpl extends TExtensibleElementsImpl implements TReassignment {
	...
	protected EClass eStaticClass() {
		return htdPackage.Literals.TREASSIGNMENT;
	}
	...
	public NotificationChain basicSetPotentialOwners(TGenericHumanRole newPotentialOwners, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, htdPackage.TREASSIGNMENT__POTENTIAL_OWNERS, oldPotentialOwners, newPotentialOwners);
	...
	public void setPotentialOwners(TGenericHumanRole newPotentialOwners) {
		if (newPotentialOwners != potentialOwners) {
			...
			if (potentialOwners != null)
				msgs = ((InternalEObject)potentialOwners).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - htdPackage.TREASSIGNMENT__POTENTIAL_OWNERS, null, msgs);
			if (newPotentialOwners != null)
				msgs = ((InternalEObject)newPotentialOwners).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - htdPackage.TREASSIGNMENT__POTENTIAL_OWNERS, null, msgs);
			msgs = basicSetPotentialOwners(newPotentialOwners, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, htdPackage.TREASSIGNMENT__POTENTIAL_OWNERS, newPotentialOwners, newPotentialOwners));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case htdPackage.TREASSIGNMENT__POTENTIAL_OWNERS:
